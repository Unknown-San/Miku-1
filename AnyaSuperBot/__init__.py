...
from AnyaSuperBot.hacking_script import PM_START_TEXT
from redis import StrictRedis
...
LOGGER = logging.getLogger("[AnyaSuperBot]")
...
if ENV:
    ...
    from AnyaSuperBot.config import Development as Config
    TOKEN = Config.TOKEN
...
print("[AnyaSuperBot]: Initializing AIOHTTP Session")
aiohttpsession = ClientSession() 

#install arq
print("[AnyaSuperBot]: Initializing ARQ Client")
arq = (ARQ_API_URL, ARQ_API_KEY, aiohttpsession)
updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
telethn = TelegramClient(MemorySession(), API_ID, API_HASH)
pbot = Client("AnyaSuperBotpbot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from AnyaSuperBot.modules.helper_funcs.handlers import (CustomCommandHandler,
